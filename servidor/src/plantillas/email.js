    ...
    <body>
        <section>
            ...
            <div>
                ...
                <a href="http://localhost:5173/validar/${validarUsuario}">http://localhost:5173/validar/${validarUsuario}</a>
            </div>
        </section>    
    </body>
    </html>
    ...
    <body>
        <section>
            ...
            <div>
                ...
                <a href="http://localhost:5173/cambiar-clave-token/${validarUsuario}">http://localhost:5173/cambiar-clave-token/${validarUsuario}</a>
            </div>
        </section>    
    </body>
    </html>
